...
public class NewsDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        contentValues.put(CategoryEntry.COLUMN_CATEGORY_NAME, mContext.getString(R.string.category_topical));
        ...
        contentValues1.put(CategoryEntry.COLUMN_CATEGORY_NAME, mContext.getString(R.string.category_global));
        ...
        contentValues2.put(CategoryEntry.COLUMN_CATEGORY_NAME, mContext.getString(R.string.category_business));
        ...
        contentValues3.put(CategoryEntry.COLUMN_CATEGORY_NAME,mContext.getString(R.string.category_education));
        contentValues3.put(CategoryEntry.COLUMN_ICON_RESOURCE,R.drawable.technology_icon);
        contentValues3.put(CategoryEntry.COLUMN_IMAGE_RESOURCE, R.drawable.science);

        db.insert(CategoryEntry.TABLE_NAME, null, contentValues3);


        ContentValues contentValues4 = new ContentValues();
        contentValues4.put(CategoryEntry._ID,"05");
        contentValues4.put(CategoryEntry.COLUMN_CATEGORY_NAME,mContext.getString(R.string.category_sport));
        contentValues4.put(CategoryEntry.COLUMN_ICON_RESOURCE,R.drawable.technology_icon);
        contentValues4.put(CategoryEntry.COLUMN_IMAGE_RESOURCE, R.drawable.science);
        db.insert(CategoryEntry.TABLE_NAME, null, contentValues4);

        ContentValues contentValues5 = new ContentValues();
        contentValues5.put(CategoryEntry._ID,"06");
        contentValues5.put(CategoryEntry.COLUMN_CATEGORY_NAME,mContext.getString(R.string.category_entertainment));
        contentValues5.put(CategoryEntry.COLUMN_ICON_RESOURCE,R.drawable.technology_icon);
        contentValues5.put(CategoryEntry.COLUMN_IMAGE_RESOURCE, R.drawable.science);
        db.insert(CategoryEntry.TABLE_NAME, null, contentValues5);

        ContentValues contentValues6 = new ContentValues();
        contentValues6.put(CategoryEntry._ID,"07");
        contentValues6.put(CategoryEntry.COLUMN_CATEGORY_NAME,mContext.getString(R.string.category_science_technology));
        contentValues6.put(CategoryEntry.COLUMN_ICON_RESOURCE,R.drawable.technology_icon);
        contentValues6.put(CategoryEntry.COLUMN_IMAGE_RESOURCE, R.drawable.science);
        db.insert(CategoryEntry.TABLE_NAME, null, contentValues6);
